...
public class ControladorEvento implements IControladorEvento {
    ...
    public void altaEvento(String nombre, String descripcion, String sigla, List<String> nombresCategorias, LocalDate fechaAltaEnPlataforma, String imagen) {
		...
		Evento e = new Evento(nombre, descripcion, sigla, fechaAltaEnPlataforma, imagen);
   ...
   public DataEvento[] getEventosDTO() {
    ...
    public DataEvento[] listarEventoExistentes() throws EventoNoExisteException {
    	 ...
    	 if (eventos != null) {
    		 ...
    		 for (Evento eve : eventos.values()) {
    			 de[i++] = new DataEvento(eve.getNombre(), eve.getDescripcionEvento(), eve.getSigla(), eve.getFecha(), eve.getCategoriasLista(), eve.getImagen());
    		 }
    ...
    public void altaEdicionEvento(
        ...
        EdicionEvento ed = new EdicionEvento( nombreEdicion, fechaInicio, fechaFin, ciudad, pais, sigla, (fechaAltaEnPlataforma != null ? fechaAltaEnPlataforma : LocalDate.now()), imagen);
        ed.setOrganizador(org);
        ed.setEventoPadre(evento);
        org.agregarEdicion(ed);
        evento.agregarEdicion(ed);
...
public DataEdicion[] listarEdicionesAceptadas() throws EdicionNoExisteException {
    ...
    if (eventos != null && !eventos.isEmpty()) {
        for (Evento eve : eventos.values()) {
            ...
            for (EdicionEvento edi : ediciones.values()) {
                if ("ACEPTADA".equals(edi.getEstadoString())) {
