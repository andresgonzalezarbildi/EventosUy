...
public class CargaDatos implements ICargaDatos {
    ...
    public void CargarDatosIniciales() {
    	...
    	try {
        	...
        	cu.altaUsuario("miseventos", "MisEventos", "contacto@miseventos.com", "imagen.jpg", "password","Organizador","Empresa de organización de eventos.", "https://miseventos.com", null, null);   
    	...
    	try {
    		//organizador: altaUsuario(nicknameU, nombreU, correoU, "Organizador", descripcionU, linkU, null, null);
        	cu.altaUsuario("techcorp", "Corporación Tecnológica", "info@techcorp.com", "imagen.jpg", "password", "Organizador","Empresa líder en tecnologías de la información.", "https://techcorp.com", null, null);  
        } catch (UsuarioRepetidoException ignored) {
            // Si ya existe, lo ignoramos 
        }
    	...
    	try {
    		//organizador: altaUsuario(nicknameU, nombreU, correoU, "Organizador", descripcionU, linkU, null, null);
        	cu.altaUsuario("imm", "Intendencia de Montevideo", "contacto@imm.gub.uy","imagen.jpg", "password", "Organizador","Gobierno departamental de Montevideo.", "https://montevideo.gub.uy",null, null);
    	} catch (UsuarioRepetidoException ignored) {
            // Si ya existe, lo ignoramos 
        }
        ...
        try {
        	//organizador: altaUsuario(nicknameU, nombreU, correoU, "Organizador", descripcionU, linkU, null, null);
            cu.altaUsuario("udelar", "Universidad de la República", "contacto@udelar.edu.uy", "imagen.jpg", "password","Organizador","Universidad pública de Uruguay.", "https://udelar.edu.uy",null, null);
        } catch (UsuarioRepetidoException ignored) {
            // Si ya existe, lo ignoramos 
        }
        ...
        try {
            //organizador: altaUsuario(nicknameU, nombreU, correoU, "Organizador", descripcionU, linkU, null, null);
            cu.altaUsuario("mec", "Ministerio de Educación y Cultura", "mec@mec.gub.uy", "imagen.jpg", "password", "Organizador", "Institución pública promotora de cultura.", "https://mec.gub.uy",null, null);
        } catch (UsuarioRepetidoException ignored) {
            // Si ya existe, lo ignoramos 
        }
     ...
     // Carga Asistentes:
        try {
            ...
            cu.altaUsuario("atorres", "Ana", "atorres@gmail.com", "imagen.jpg", "password", "Asistente",null, null, "Torres", LocalDate.of(1990, 5, 12));
        } catch (UsuarioRepetidoException ignored) {
            // Si ya existe, lo ignoramos
        }
        ...
        try {
        	//asisente: altaUsuario(nicknameU, nombreU, correoU, "Asistente", null, null, apellidoU, fechaNacLD);
            cu.altaUsuario("msilva", "Martin", "martin.silva@fing.edu.uy", "imagen.jpg", "password", "Asistente",null, null, "Silva", LocalDate.of(1987, 8, 21));
        } catch (UsuarioRepetidoException ignored) {
            // Si ya existe, lo ignoramos
        }
        ...
        try {
        	//asisente: altaUsuario(nicknameU, nombreU, correoU, "Asistente", null, null, apellidoU, fechaNacLD);
            cu.altaUsuario("sofirod", "Sofia", "srodriguez@outlook.com", "imagen.jpg", "password", "Asistente",null, null, "Rodriguez", LocalDate.of(1995, 2, 3));
        ...
        try {
        	//asisente: altaUsuario(nicknameU, nombreU, correoU, "Asistente", null, null, apellidoU, fechaNacLD);
            cu.altaUsuario("vale23", "Valentina", "valentina.costa@mail.com", "imagen.jpg", "password", "Asistente",null, null, "Costa", LocalDate.of(1992, 12, 1));
        } catch (UsuarioRepetidoException ignored) {
            // Si ya existe, lo ignoramos
        }
        ...
        try {
        	//asisente: altaUsuario(nicknameU, nombreU, correoU, "Asistente", null, null, apellidoU, fechaNacLD);
            cu.altaUsuario("luciag", "Lucía", "lucia.garcia@mail.com", "imagen.jpg", "password", "Asistente",null, null, "Garcia", LocalDate.of(1993, 11, 9));
        } catch (UsuarioRepetidoException ignored) {
            // Si ya existe, lo ignoramos
        }
        ...
        try {
        	//asisente: altaUsuario(nicknameU, nombreU, correoU, "Asistente", null, null, apellidoU, fechaNacLD);
            cu.altaUsuario("andrearod", "Andrea", "andrea.rod@mail.com", "imagen.jpg", "password", "Asistente",null, null, "Rodriguez", LocalDate.of(2000, 6, 10));
        } catch (UsuarioRepetidoException ignored) {
            // Si ya existe, lo ignoramos
        }
        ...
        try {
        	//asisente: altaUsuario(nicknameU, nombreU, correoU, "Asistente", null, null, apellidoU, fechaNacLD);
            cu.altaUsuario("AnaG", "Ana", "ana.gomez@hotmail.com","imagen.jpg", "password", "Asistente", null, null, "Gomez", LocalDate.of(1998, 3, 15));
        } catch (UsuarioRepetidoException ignored) {
            // Si ya existe, lo ignoramos
        }
        ...
        try {
        	//asisente: altaUsuario(nicknameU, nombreU, correoU, "Asistente", null, null, apellidoU, fechaNacLD);
            cu.altaUsuario("JaviL", "Javier", "javier.lopez@outlook.com","imagen.jpg", "password", "Asistente",null, null, "Lopez", LocalDate.of(1995, 7, 22));
        } catch (UsuarioRepetidoException ignored) {
            // Si ya existe, lo ignoramos
        }
        ...
        try {
        	//asisente: altaUsuario(nicknameU, nombreU, correoU, "Asistente", null, null, apellidoU, fechaNacLD);
            cu.altaUsuario("MariR", "Maria", "maria.rodriguez@gmail.com", "imagen.jpg", "password", "Asistente",null, null, "Rodriguez", LocalDate.of(2000, 11, 10));
        } catch (UsuarioRepetidoException ignored) {
            // Si ya existe, lo ignoramos
        }
        ...
        try {
        	//asisente: altaUsuario(nicknameU, nombreU, correoU, "Asistente", null, null, apellidoU, fechaNacLD);
            cu.altaUsuario("SofiM", "Sofia", "sofia.martinez@yahoo.com", "imagen.jpg", "password", "Asistente", null, null, "Martinez", LocalDate.of(1997, 2, 5));
        } catch (UsuarioRepetidoException ignored) {
            // Si ya existe, lo ignoramos
        }
        ...
        try {
        	//	10/01/2025 
            ce.altaEvento("Conferencia de Tecnología", "Evento sobre innovación tecnolígica", "CONFTEC", List.of("Tecnología","Innovación"),LocalDate.of(2025,1,10), "IMG-EDEV03.jpeg");
        } catch (IllegalArgumentException ignored) {}
        
        try {
        	//	01/02/2025
            ce.altaEvento("Feria del Libro", "Encuentro anual de literatura", "FERLIB", List.of("Literatura","Cultura"),LocalDate.of(2025,2,1), "IMG-EDEV04.jpeg");
        } catch (IllegalArgumentException ignored) {}
        
        try {
        	// 15/03/2023 
            ce.altaEvento("Montevideo Rock", "Festival de rock con artistas nacionales e internacionales", "MONROCK", List.of("Cultura","Música"),LocalDate.of(2023,3,15), "IMG-EV04.png");
        } catch (IllegalArgumentException ignored) {}
        
        try {
        	//	01/01/2022 
            ce.altaEvento("Maratón de Montevideo 3333", "Competencia deportiva anual en la capital", "MARATON", List.of("Deporte","Salud"),LocalDate.of(2022,1,1), "IMG-EDEV09.png");
        } catch (IllegalArgumentException ignored) {}
        
        try {
        	//	10/04/2024 
            ce.altaEvento("Montevideo Comics 5555", "Convención de historietas, cine y cultura geek", "COMICS", List.of("Cultura","Entretenimiento"),LocalDate.of(2024,4,10), "IMG-US01.jpg");
        } catch (IllegalArgumentException ignored) {}
        
        try {
        	//	12/12/2024
            ce.altaEvento("Expointer Uruguay", "Exposición internacional agropecuaria y ganadera", "EXPOAGRO", List.of("Agro","Negocios"), LocalDate.of(2024,12,12), "IMG-US04.jpeg");
        } catch (IllegalArgumentException ignored) {}
        try {
        	//	20/07/2025 
            ce.altaEvento("Montevideo Fashion Week", "Pasarela de moda uruguaya e internacional", "MFASHION", List.of("Cultura","Investigación"),LocalDate.of(2025,7,20), "immAvatar.jpg");
        } catch (IllegalArgumentException ignored) {}
     ...
     // Carga edición de evento
        ...
        try {
            ce.altaEdicionEvento("Montevideo Rock","Montevideo Rock 2025", "MONROCK25","Montevideo", "Uruguay",LocalDate.of(2025,11,20),LocalDate.of(2025,11,22),LocalDate.of(2025,3,12),"imm");
        } catch (UsuarioNoExisteException ignored) {}
        
        try {
            ce.altaEdicionEvento("Maratón de Montevideo","Maratón de Montevideo 2025", "MARATON25","Montevideo", "Uruguay",LocalDate.of(2025,9,14),LocalDate.of(2025,9,14),LocalDate.of(2025,2,5),"imm");
        } catch (UsuarioNoExisteException ignored) {}
        
        try {
            ce.altaEdicionEvento("Maratón de Montevideo","Maratón de Montevideo 2024", "MARATON24","Montevideo", "Uruguay",LocalDate.of(2024,9,14),LocalDate.of(2024,9,14),LocalDate.of(2024,4,21),"imm");
        } catch (UsuarioNoExisteException ignored) {}
        
        try {
            ce.altaEdicionEvento("Maratón de Montevideo","Maratón de Montevideo 2022", "MARATON22","Montevideo", "Uruguay",LocalDate.of(2022,9,14),LocalDate.of(2022,9,14),LocalDate.of(2022,5,21),"imm");
        } catch (UsuarioNoExisteException ignored) {}

        try {
            ce.altaEdicionEvento("Montevideo Comics","Montevideo Comics 2024", "COMICS24","Montevideo", "Uruguay",LocalDate.of(2024,7,18),LocalDate.of(2024,7,21),LocalDate.of(2024,6,20),"miseventos");
        } catch (UsuarioNoExisteException ignored) {}
        
        try {
            ce.altaEdicionEvento("Montevideo Comics","Montevideo Comics 2025", "COMICS25","Montevideo", "Uruguay",LocalDate.of(2025,8,4),LocalDate.of(2025,8,6),LocalDate.of(2025,7,4),"miseventos");
        } catch (UsuarioNoExisteException ignored) {}
        
        try {
            ce.altaEdicionEvento("Expointer Uruguay","Expointer Uruguay 2025", "EXPOAGRO25","Durazno", "Uruguay",LocalDate.of(2025,9,11),LocalDate.of(2025,9,17),LocalDate.of(2025,2,1),"miseventos");
        } catch (UsuarioNoExisteException ignored) {}
        
        try {
            ce.altaEdicionEvento("Conferencia de Tecnología","Tecnología Punta del Este 2026", "CONFTECH26","Punta del Este", "Uruguay",LocalDate.of(2026,4,6),LocalDate.of(2026,4,10),LocalDate.of(2025,8,1),"udelar");
        } catch (UsuarioNoExisteException ignored) {}
        
        try {
            ce.altaEdicionEvento("Conferencia de Tecnología","Mobile World Congress 2025", "MWC","Barcelona", "España",LocalDate.of(2025,12,12),LocalDate.of(2025,12,15),LocalDate.of(2025,8,21),"techcorp");
        } catch (UsuarioNoExisteException ignored) {}
        
        try {
            ce.altaEdicionEvento("Conferencia de Tecnología","Web Summit 2026", "WS26","Lisboa", "Portugal",LocalDate.of(2026,1,13),LocalDate.of(2026,2,1),LocalDate.of(2025,6,4),"techcorp");
        } catch (UsuarioNoExisteException ignored) {}
