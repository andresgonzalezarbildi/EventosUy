...
public class EdicionEvento {
	...
	public EstadoEdicion getEstado() { return estado; }
	
	public String getEstadoString() { return estado.name().toLowerCase(); }
	...
	public void aceptar(){
	    if (estado == EstadoEdicion.ACEPTADA) return;
	    this.estado = EstadoEdicion.ACEPTADA;
	}

	public void rechazar() {
	    if (estado == EstadoEdicion.RECHAZADA) return;
