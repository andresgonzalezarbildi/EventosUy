...
public class Organizador extends Usuario {
  ...
  private Map<String, EdicionEvento> edicionesOrganizadas;

  public Organizador(String nickname, String nombre, String correoElectronico, String imagen, String password,
                     String descripcionGeneral, String linkSitioWeb) {
    super(nickname, nombre, correoElectronico, imagen, password);
  ...
  public Map<String, EdicionEvento> getEdicionesOrganizadas() {
