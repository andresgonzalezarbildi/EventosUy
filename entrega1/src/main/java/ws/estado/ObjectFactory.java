...
public class ObjectFactory {
    ...
    private static final QName _Ping_QNAME = new QName("http://publicar.ws/", "ping");
    private static final QName _PingResponse_QNAME = new QName("http://publicar.ws/", "pingResponse");
     ...
     */
    @XmlElementDecl(namespace = "http://publicar.ws/", name = "ping")
     ...
     */
    @XmlElementDecl(namespace = "http://publicar.ws/", name = "pingResponse")
