...
public class CargaDatos implements ICargaDatos {
    ...
    public void CargarDatosIniciales() {
    	...
    	try {
        	...
        	cu.altaUsuario("miseventos", "MisEventos", "contacto@miseventos.com","Organizador","Empresa de organización de eventos.", "https://miseventos.com", null, null);   
    	...
    	try {
    		//organizador: altaUsuario(nicknameU, nombreU, correoU, "Organizador", descripcionU, linkU, null, null);
        	cu.altaUsuario("techcorp", "Corporación Tecnológica", "info@techcorp.com","Organizador","Empresa líder en tecnologías de la información.", "https://techcorp.com", null, null);  
        } catch (UsuarioRepetidoException ignored) {
            // Si ya existe, lo ignoramos 
        }
    	...
    	try {
    		//organizador: altaUsuario(nicknameU, nombreU, correoU, "Organizador", descripcionU, linkU, null, null);
        	cu.altaUsuario("imm", "Intendencia de Montevideo", "contacto@imm.gub.uy","Organizador","Gobierno departamental de Montevideo.", "https://montevideo.gub.uy",null, null);
    	} catch (UsuarioRepetidoException ignored) {
            // Si ya existe, lo ignoramos 
        }
        ...
        try {
        	//organizador: altaUsuario(nicknameU, nombreU, correoU, "Organizador", descripcionU, linkU, null, null);
            cu.altaUsuario("udelar", "Universidad de la República", "contacto@udelar.edu.uy","Organizador","Universidad pública de Uruguay.", "https://udelar.edu.uy",null, null);
        } catch (UsuarioRepetidoException ignored) {
            // Si ya existe, lo ignoramos 
        }
        ...
        try {
            //organizador: altaUsuario(nicknameU, nombreU, correoU, "Organizador", descripcionU, linkU, null, null);
            cu.altaUsuario("mec", "Ministerio de Educación y Cultura", "mec@mec.gub.uy","Organizador", "Institución pública promotora de cultura.", "https://mec.gub.uy",null, null);
        } catch (UsuarioRepetidoException ignored) {
            // Si ya existe, lo ignoramos 
        }
     ...
     // Carga Asistentes:
        try {
            ...
            cu.altaUsuario("atorres", "Ana", "atorres@gmail.com", "Asistente",null, null, "Torres", LocalDate.of(1990, 5, 12));
        } catch (UsuarioRepetidoException ignored) {
            // Si ya existe, lo ignoramos
        }
        ...
        try {
        	//asisente: altaUsuario(nicknameU, nombreU, correoU, "Asistente", null, null, apellidoU, fechaNacLD);
            cu.altaUsuario("sofirod", "Sofia", "srodriguez@outlook.com", "Asistente",null, null, "Rodriguez", LocalDate.of(1995, 2, 3));
        ...
        try {
        	//asisente: altaUsuario(nicknameU, nombreU, correoU, "Asistente", null, null, apellidoU, fechaNacLD);
            cu.altaUsuario("vale23", "Valentina", "valentina.costa@mail.com", "Asistente",null, null, "Costa", LocalDate.of(1992, 12, 1));
        } catch (UsuarioRepetidoException ignored) {
            // Si ya existe, lo ignoramos
        }
        ...
        try {
        	//asisente: altaUsuario(nicknameU, nombreU, correoU, "Asistente", null, null, apellidoU, fechaNacLD);
            cu.altaUsuario("luciag", "Lucía", "lucia.garcia@mail.com", "Asistente",null, null, "Garcia", LocalDate.of(1993, 11, 9));
        } catch (UsuarioRepetidoException ignored) {
            // Si ya existe, lo ignoramos
        }
        ...
        try {
        	//asisente: altaUsuario(nicknameU, nombreU, correoU, "Asistente", null, null, apellidoU, fechaNacLD);
            cu.altaUsuario("andrearod", "Andrea", "andrea.rod@mail.com", "Asistente",null, null, "Rodriguez", LocalDate.of(2000, 6, 10));
        } catch (UsuarioRepetidoException ignored) {
            // Si ya existe, lo ignoramos
        }
        ...
        try {
        	//asisente: altaUsuario(nicknameU, nombreU, correoU, "Asistente", null, null, apellidoU, fechaNacLD);
            cu.altaUsuario("AnaG", "Ana", "ana.gomez@hotmail.com", "Asistente", null, null, "Gomez", LocalDate.of(1998, 3, 15));
        } catch (UsuarioRepetidoException ignored) {
            // Si ya existe, lo ignoramos
        }
        ...
        try {
        	//asisente: altaUsuario(nicknameU, nombreU, correoU, "Asistente", null, null, apellidoU, fechaNacLD);
            cu.altaUsuario("JaviL", "Javier", "javier.lopez@outlook.com", "Asistente",null, null, "Lopez", LocalDate.of(1995, 7, 22));
        } catch (UsuarioRepetidoException ignored) {
            // Si ya existe, lo ignoramos
        }
        ...
        try {
        	//asisente: altaUsuario(nicknameU, nombreU, correoU, "Asistente", null, null, apellidoU, fechaNacLD);
            cu.altaUsuario("MariR", "Maria", "maria.rodriguez@gmail.com", "Asistente",null, null, "Rodriguez", LocalDate.of(2000, 11, 10));
        } catch (UsuarioRepetidoException ignored) {
            // Si ya existe, lo ignoramos
        }
        ...
        try {
        	//asisente: altaUsuario(nicknameU, nombreU, correoU, "Asistente", null, null, apellidoU, fechaNacLD);
            cu.altaUsuario("SofiM", "Sofia", "sofia.martinez@yahoo.com", "Asistente", null, null, "Martinez", LocalDate.of(1997, 2, 5));
        } catch (UsuarioRepetidoException ignored) {
            // Si ya existe, lo ignoramos
        }
