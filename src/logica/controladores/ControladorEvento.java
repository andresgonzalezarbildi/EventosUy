...
public class ControladorEvento implements IControladorEvento {
   ...
   public DataEvento[] getEventosDTO() {
    ...
    public DataEdicion getEdicion(String nombreEvento, String nombreEdicion) {
        ...
        return  new DataEdicion(edi.getNombre(), edi.getFechaIni(), edi.getFechaFin(), edi.getCiudad(), edi.getPais(), edi.getSigla(), edi.getFechaAltaEnPlataforma());
    }
