          	...
          	<h2 style="margin-bottom: 1rem; color: var(--color-primary); text-align:center;">
          		Detalle de su Registro
					  ...
					  <% if(edicionIniciada) { 
					  	...
					  	<form method="post" action="<%= request.getContextPath() %>/mobile/confirmarAsistencia" style="display:inline;">
			...
			<div class="col-12 col-md-4" style="display:flex; flex-direction:column; align-items:center;">
				...
				%>
				    <div style="margin-bottom:12px; text-align:center;">
				        <a href="<%= request.getContextPath() %>/mobile/consultaEdicion?id=<%= edicion.getNombre() %>">
